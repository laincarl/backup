...
def fillUnivlist(lis,li,html):
    try:
        patten = re.compile(r'<div id="post_content_\d*" class="d_post_content j_d_post_content  clearfix">(.*?)</div>', re.S)
...
def main():
    count = 0
    url = 'http://tieba.baidu.com/p/5071176036?see_lz=1&pn=1'
    ...
    #     lis = []
    #     li = []
    #     url = 'http://tieba.baidu.com/p/5071176036?see_lz=1&pn=' + str(i)
    #     html = getHTMLText(url)
    #     #print(html)
    ...
    lis = []
    li = []
    url = 'http://tieba.baidu.com/p/5071176036?see_lz=1'
    html = getHTMLText(url)
    #print(html)
    fillUnivlist(lis, li, html)
    writeUnivlist(lis, li, output_file, len(lis))
